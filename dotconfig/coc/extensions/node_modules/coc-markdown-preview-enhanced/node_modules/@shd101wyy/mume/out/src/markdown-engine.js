...
`;
     ...
     */
    resolveFilePath(filePath = "", relative, fileDirectoryPath = "") {
        if (filePath.match(this.protocolsWhiteListRegExp) ||
            ...
            if (relative) {
                return path.relative(fileDirectoryPath || this.fileDirectoryPath, path.resolve(this.projectDirectoryPath, "." + filePath));
            }
            else {
            ...
            if (relative) {
                ...
                return utility.addFileProtocol(path.resolve(fileDirectoryPath || this.fileDirectoryPath, filePath), this.vscodePreviewPanel);
            }
        }
    }
    /**
    ...
    */
    ...
    parseMD(inputString, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, fenced_diagrams_1.default)($, this.graphsCache, options.fileDirectoryPath || this.fileDirectoryPath, (0, utility_1.removeFileProtocol)(this.resolveFilePath(this.config.imageFolderPath, false)), this.config.plantumlServer);
