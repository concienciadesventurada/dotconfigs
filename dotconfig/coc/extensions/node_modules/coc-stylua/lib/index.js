  ...
  module2.exports = function(Promise2, apiRejection, INTERNAL2, tryConvertToPromise, Proxyable, debug) {
    ...
    Promise2.coroutine = function(generatorFunction, options) {
      ...
      return function() {
        ...
        var spawn2 = new PromiseSpawn$(void 0, void 0, yieldHandler, stack);
...
var require_promisify2 = __commonJS((exports2, module2) => {
  "use strict";
  module2.exports = function(Promise2, INTERNAL2) {
    var THIS = {};
    var util2 = require_util();
    ...
    if (true) {
      ...
      makeNodePromisifiedEval = function(callback, receiver, originalName, fn, _, multiArgs) {
        ...
        return new Function("Promise", "fn", "receiver", "withAppended", "maybeWrapAsError", "nodebackForPromise", "tryCatch", "errorObj", "notEnumerableProp", "INTERNAL", body)(Promise2, fn, receiver, withAppended2, maybeWrapAsError2, nodebackForPromise, util2.tryCatch, util2.errorObj, util2.notEnumerableProp, INTERNAL2);
      };
    }
...
var require_promise = __commonJS((exports2, module2) => {
  ...
  module2.exports = function() {
    ...
    require_promisify2()(Promise2, INTERNAL2);
...
var require_parse2 = __commonJS((exports2, module2) => {
  ...
  util2.inherits(Parse2, PullStream);
...
var require_dir_reader = __commonJS((exports2, module2) => {
  ...
  DirReader.prototype._read = function() {
    ...
    var p = path4.resolve(self2._path, self2.entries[self2._index]);
    ...
    fs2[self2.props.follow ? "stat" : "lstat"](p, function(er, stat) {
      ...
      stat.path = p;
      stat.basename = path4.basename(p);
      stat.dirname = path4.dirname(p);
      var childProps = self2.getChildProps.call(who, stat);
      childProps.path = p;
      childProps.basename = path4.basename(p);
      childProps.dirname = path4.dirname(p);
...
var require_reader = __commonJS((exports2, module2) => {
  ...
  function Reader(props, currentStat) {
    ...
    self2._path = self2.path = path4.resolve(props.path);
    if (process.platform === "win32") {
    ...
    self2.basename = props.basename = path4.basename(self2.path);
    self2.dirname = props.dirname = path4.dirname(self2.path);
...
var require_dir_writer = __commonJS((exports2, module2) => {
  ...
  DirWriter.prototype._process = function() {
    ...
    props.path = path4.join(self2.path, path4.join("/", pp));
...
var require_link_writer = __commonJS((exports2, module2) => {
  ...
  LinkWriter.prototype._create = function() {
    ...
    var lp = hard ? path4.resolve(self2.dirname, self2.linkpath) : self2.linkpath;
    if (hard)
...
var require_writer = __commonJS((exports2, module2) => {
  ...
  function Writer(props, current) {
    ...
    self2.basename = path4.basename(props.path);
    self2.dirname = path4.dirname(props.path);
  ...
  function create(self2) {
    mkdir(path4.dirname(self2._path), Writer.dirmode, function(er, made) {
      if (er)
        return self2.error(er);
      self2._madeDir = made;
  ...
  function endChmod(self2, want, current, path5, cb) {
    ...
    if (wantMode === curMode)
      return cb();
    fs2[chmod](path5, wantMode, cb);
  }
  function endChown(self2, want, current, path5, cb) {
    if (process.platform === "win32")
      return cb();
    ...
    fs2[chown](path5, want.uid, want.gid, cb);
  }
  function endUtimes(self2, want, current, path5, cb) {
...
var require_extract = __commonJS((exports2, module2) => {
  ...
  function Extract(opts) {
    opts.path = path4.resolve(path4.normalize(opts.path));
    var parser = new Parse2(opts);
    var outStream = new stream.Writable({objectMode: true});
    outStream._write = function(entry, encoding, cb) {
      if (entry.type == "Directory")
        return cb();
      var extractPath = path4.join(opts.path, entry.path);
...
var require_unzip = __commonJS((exports2, module2) => {
  ...
  if (!Stream2.Writable || !Stream2.Writable.prototype.destroy)
    Stream2 = require_readable();
  module2.exports = function unzip2(source, offset, _password, directoryVars) {
        ...
        return records.pull(46).then(function(data) {
          ...
          return records.pull(vars2.fileNameLength).then(function(fileNameBuffer) {
            ...
            vars2.stream = function(_password) {
              return unzip2(source, vars2.offsetToLocalFileHeader, _password, vars2);
            };
...
var require_ignore = __commonJS((exports2, module2) => {
  ...
  var IgnoreBase = class {
    ...
    filter(paths) {
      return make_array(paths).filter((path4) => this._filter(path4));
    }
    createFilter() {
      return (path4) => this._filter(path4);
    }
    ignores(path4) {
      return !this._filter(path4);
    }
    _filter(path4, slices) {
      if (!path4) {
        return false;
      }
      if (path4 in this._cache) {
        return this._cache[path4];
      }
      if (!slices) {
        slices = path4.split(SLASH);
      }
      slices.pop();
      return this._cache[path4] = slices.length ? this._filter(slices.join(SLASH) + SLASH, slices) && this._test(path4) : this._test(path4);
    }
    _test(path4) {
      let matched = 0;
      this._rules.forEach((rule) => {
        if (!(matched ^ rule.negative)) {
          matched = rule.negative ^ rule.regex.test(path4);
        }
      });
      return !matched;
    }
  ...
  if (typeof process !== "undefined" && (process.env && process.env.IGNORE_TEST_WIN32 || process.platform === "win32")) {
    ...
    IgnoreBase.prototype._filter = function filterWin32(path4, slices) {
      path4 = make_posix(path4);
      return filter.call(this, path4, slices);
    };
  }
...
var unzip = __toModule(require_unzip2());
...
var configPath = coc.workspace.getConfiguration("stylua").get("configPath");
async function checkIgnored(filePath, currentWorkspace) {
  if (!filePath || !currentWorkspace) {
    return false;
  }
  const ignoreFilePath = import_path.default.join(currentWorkspace, ".styluaignore");
  if (await fileExists(ignoreFilePath)) {
    try {
      const contents = await coc.workspace.readFile(ignoreFilePath);
      const ig = (0, import_ignore.default)().add(contents.toString());
...
function formatCode(path4, code, cwd, startPos, endPos) {
  return new Promise((resolve, reject) => {
    const args = [];
    if (startPos) {
    ...
    args.push("-");
    const child = (0, import_child_process.spawn)(path4, args, {cwd});
    let output = "";
...
function executeStylua(path4, args, cwd) {
  return new Promise((resolve, reject) => {
    var _a;
    (0, import_child_process.exec)(`"${path4}" ${(_a = args == null ? void 0 : args.join(" ")) != null ? _a : ""}`, {
      cwd
    }, (err, stdout) => {
      if (err) {
        reject(err);
...
// src/util.ts
var RELEASES_URL = "https://api.github.com/repos/JohnnyMorganz/StyLua/releases";
var agent = () => process.env.https_proxy ? new import_https_proxy_agent.HttpsProxyAgent(process.env.https_proxy) : null;
var getRelease = async (version) => {
  if (version === "latest") {
    return await (await lib_default(RELEASES_URL + "/latest", {agent: agent(), timeout: 1e4})).json();
  }
  version = version.startsWith("v") ? version : "v" + version;
  const releases = await (await lib_default(RELEASES_URL)).json();
...
var getDesiredVersion = () => {
  const config = coc2.workspace.getConfiguration("stylua");
  const targetVersion = config.get("targetReleaseVersion", "").trim();
  if (targetVersion.length === 0) {
    return config.get("releaseVersion", "latest");
  }
  return targetVersion;
};
var fileExists = async (path4) => {
  const uri = path4 instanceof coc2.Uri ? path4 : coc2.Uri.file(path4);
  return fs.promises.stat(uri.fsPath).then(() => true, () => false);
};
var downloadStylua = async (outputDirectory) => {
  ...
  for (const asset of release.assets) {
    if (assetFilename.test(asset.name)) {
      const file = fs.createWriteStream(import_path2.default.join(outputDirectory, outputFilename), {
        mode: 493
      });
      return new Promise(async (resolve, reject) => {
        lib_default(asset.browser_download_url, {
          headers: {
            "User-Agent": "stylua-vscode"
          },
          timeout: 1e4,
          agent: agent()
        }).then((res) => res.body.pipe(unzip.Parse())).then((stream) => {
...
var downloadStyLuaVisual = (outputDirectory) => {
  return coc2.window.withProgress({
    title: "Downloading StyLua",
    cancellable: false
  }, () => downloadStylua(outputDirectory));
};
var getStyluaPath = async (storageDirectory) => {
  const settingPath = coc2.workspace.getConfiguration("stylua").get("styluaPath");
  if (settingPath) {
    return settingPath;
  }
  const downloadPath = import_path2.default.join(storageDirectory, getDownloadOutputFilename());
  if (await fileExists(downloadPath)) {
    return downloadPath;
  }
};
var ensureStyluaExists = async (storageDirectory) => {
  var _a;
  const path4 = await getStyluaPath(storageDirectory);
  if (path4 === void 0) {
    if (!fileExists(storageDirectory.toString()))
    ...
    if (!await fileExists(path4)) {
      coc2.window.showErrorMessage(`The path given for StyLua (${path4}) does not exist`);
      return;
    }
    const config = coc2.workspace.getConfiguration("stylua");
    const checkUpdate = config.get("checkUpdate", true);
    try {
      const currentVersion = (_a = await executeStylua(path4, ["--version"])) == null ? void 0 : _a.trim().split(" ")[1];
      ...
      coc2.window.showWarningMessage(`Error checking the selected StyLua version, falling back to the currently installed version:
${err}`);
    }
    return path4;
  }
...
function openUpdatePrompt(directory, release) {
  coc2.window.showInformationMessage(`StyLua ${release.tag_name} is available to install.`, "Install", "Later").then((option) => {
    switch (option) {
      case "Install":
...
var byteOffset = (document2, position) => {
  const textRange = coc3.Range.create(document2.positionAt(0), position);
  const text = document2.getText(textRange);
  return Buffer.byteLength(text);
};
async function activate(context) {
  console.log("stylua activated");
  let styluaBinaryPath = await ensureStyluaExists(context.storagePath);
  context.subscriptions.push(coc3.commands.registerCommand("stylua.reinstall", async () => {
    await downloadStyLuaVisual(context.storagePath);
    styluaBinaryPath = await getStyluaPath(context.storagePath);
  }));
  context.subscriptions.push(coc3.workspace.onDidChangeConfiguration(async (change) => {
    if (change.affectsConfiguration("stylua")) {
      styluaBinaryPath = await ensureStyluaExists(context.storagePath);
    }
  }));
  async function provideDocumentRangeFormattingEdits(document2, range) {
    if (!styluaBinaryPath) {
      coc3.window.showErrorMessage("StyLua not found. Could not format file", "Install").then((option) => {
        if (option === "Install") {
          downloadStyLuaVisual(context.storagePath);
        }
      });
      return [];
    }
    const currentWorkspace = coc3.workspace.getWorkspaceFolder(document2.uri);
    let cwd = currentWorkspace == null ? void 0 : currentWorkspace.uri;
    if (cwd) {
      cwd = import_path3.default.normalize(coc3.Uri.parse(cwd).fsPath);
    }
    if (await checkIgnored(document2.uri, currentWorkspace == null ? void 0 : currentWorkspace.uri)) {
      return [];
    }
    const text = document2.getText();
    try {
      const formattedText = await formatCode(styluaBinaryPath, text, cwd, byteOffset(document2, range.start), byteOffset(document2, range.end));
      if (!formattedText.length)
        return;
      const lastLineNumber = document2.lineCount - 1;
      const doc = coc3.workspace.getDocument(document2.uri);
      const fullDocumentRange = coc3.Range.create({line: 0, character: 0}, {line: lastLineNumber, character: doc.getline(lastLineNumber).length});
      const format = coc3.TextEdit.replace(fullDocumentRange, formattedText);
      return [format];
    } catch (err) {
      coc3.window.showErrorMessage(`Could not format file: ${err}`);
      return [];
    }
  }
  async function provideDocumentFormattingEdits(document2) {
    const doc = coc3.workspace.getDocument(document2.uri);
    const lastLine = doc.lineCount - 1;
    const range = coc3.Range.create({character: 0, line: 0}, {character: doc.getline(lastLine).length, line: lastLine});
    return await provideDocumentRangeFormattingEdits(document2, range);
  }
  context.subscriptions.push(coc3.languages.registerDocumentRangeFormatProvider(["lua"], {provideDocumentRangeFormattingEdits}, 999), coc3.languages.registerDocumentFormatProvider(["lua"], {provideDocumentFormattingEdits}, 999));
}
function deactivate() {
}
